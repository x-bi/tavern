...
export type ValidatedEnv = {
  ...
  QQ_EVENT_CALLBACK_BASE_URL: string;
  QQ_AUTO_NAPCAT_API_BASE_URL: string;
  QQ_LOGIN_QR_PATH: string;
  QQ_LOGIN_DATA_PATH: string;
...
const DEFAULT_ENV: ValidatedEnv = {
  ...
  QQ_EVENT_CALLBACK_BASE_URL: 'http://127.0.0.1:3100/api',
  QQ_AUTO_NAPCAT_API_BASE_URL: 'http://127.0.0.1:3000',
  QQ_LOGIN_QR_PATH: 'data/napcat/cache/qrcode.png',
  QQ_LOGIN_DATA_PATH: 'data/napcat/qq',
...
export function validateEnv(config: RawEnv): ValidatedEnv {
  ...
  return {
    ...
    QQ_EVENT_CALLBACK_BASE_URL: merged.QQ_EVENT_CALLBACK_BASE_URL.replace(/\/$/, ''),
    QQ_AUTO_NAPCAT_API_BASE_URL: merged.QQ_AUTO_NAPCAT_API_BASE_URL.replace(/\/$/, ''),
    QQ_LOGIN_QR_PATH: merged.QQ_LOGIN_QR_PATH,
    QQ_LOGIN_DATA_PATH: merged.QQ_LOGIN_DATA_PATH,
